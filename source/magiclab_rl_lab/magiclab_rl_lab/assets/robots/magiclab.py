...
MAGICLAB_Z1_23DOF_CFG = MagiclabArticulationCfg(
    spawn=MagiclabUrdfFileCfg(
        asset_path=f"{MAGICLAB_ROS_DIR}/source/magiclab_rl_lab/magiclab_rl_lab/data/robots/magicbot-Z1/urdf/MagicBotZ1_23dof.urdf",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.69),
        joint_pos={
            # Legs (same as 12DOF standing pose)
            ".*_hip_roll_joint": 0.0,
            ".*_hip_yaw_joint": 0.0,
            ".*_hip_pitch_joint": -0.35,
            ".*_knee_joint": 0.7,
            ".*_ankle_pitch_joint": -0.35,
            ".*_ankle_roll_joint.*": 0.0,
            # Arms (ready pose: slightly forward, elbows bent)
